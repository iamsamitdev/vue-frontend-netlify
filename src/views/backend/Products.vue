         ...
         <div class="z-50 w-11/12 p-5 mx-auto overflow-y-auto bg-white rounded shadow-lg h-4/5 modal-container md:max-w-md">
            ...
            <div class="w-full h-auto mb-4">
                <form ref="addProductForm" @submit.prevent="onSubmit" enctype="multipart/form-data">
                    ...
                    <ckeditor :editor="editor" v-model="description" :config="editorConfig" class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow"></ckeditor>
    ...
    data(){
        return {
            ...
            editorConfig: {
                ...
                // toolbar: [ 'heading','bold', 'italic', 'bulletedList', 'numberedList', 'blockQuote','styles' ],
                // heading: {
                //     options: [
